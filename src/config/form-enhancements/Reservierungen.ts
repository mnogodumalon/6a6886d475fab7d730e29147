// Auto-generated. Per-entity form-enhancements config for "Reservierungen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["datum_uhrzeit", "personenanzahl", "tisch", {"row": ["gast_vorname", "gast_nachname"]}, "gast_telefon", "gast_email", "anlass", "bestaetigung", "bemerkungen_reservierung"],
  defaults: {
    'datum_uhrzeit': { kind: 'today', withTime: true },
    'personenanzahl': { kind: 'literal', value: 1 },
    'bestaetigung': { kind: 'lookup', key: 'nicht_bestaetigt', label: 'Nicht bestätigt' },
  },
  computed: {},
};
